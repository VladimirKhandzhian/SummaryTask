...
public class AddToBrigad extends Command{

	private static final long serialVersionUID = 1L;
	private static final Logger LOGGER = Logger.getLogger(AddToBrigad.class);
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		LOGGER.debug("Session parameter: dispatcherId --> " + dispatcherId);
		
		String forward = Page.DISPATCHER_CABINET_PAGE;
		
		daoInterfaceBrigads.insertBrigads(brigadId, workerId);
